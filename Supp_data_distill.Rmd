...
forestplot(summary(fit_mi,age=c(50,60),preleuka_LDH_l=c(2,2.3),preleuka_bulk_s=c(1,2),preleuka_ALC_l=c(2,2.3)),digits=2,title="OR for complete response (best response by PET or CT)",row.names.y = newnames,header = newhead)
